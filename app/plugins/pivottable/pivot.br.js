(function() {
  ...
  callWithJQuery(function($) {
    ...
    return $.pivotUtilities.locales.br = {
      localeStrings: {
      ...
      aggregators: {
        "Quantidade": tpl.count(frFmtInt),
        "Quantidade de Valores Únicos": tpl.countUnique(frFmtInt),
        "Lista Valores Únicos": tpl.listUnique(", "),
        "Soma": tpl.sum(frFmt),
        "Soma em inteiros": tpl.sum(frFmtInt),
